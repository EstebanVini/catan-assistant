...
import { Building, Hex, PortType, Resource } from '../types';
...
export function ConstructionTable(): JSX.Element | null {
  ...
  function confirmPort(buildingId: string, port: PortType | null): void {
    ...
    // Los puertos los deriva el server desde `player:setBuildings`
    // (player.ports = buildings con puerto); el cliente no los sincroniza.
    setPortSheet(null);
  }
